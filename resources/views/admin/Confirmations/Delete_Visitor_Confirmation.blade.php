<div id="confirmationPopup" class="confirm-popup hidden">
    <form class="confirm-popup-content" method="POST" action="{{ route('delete_visitor') }}">
        @csrf
        <input type="text" name="id" id="visitorIdtoDelete">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const visitorIdtoDelete = document.getElementById('visitorIdtoDelete');
        ...
        deleteButton.addEventListener('click', function() {
            ...
            if (selectedIds.length === 1) {
                ...
                visitorIdtoDelete.value = selectedIds[
                ...
                visitorIdtoDelete.value = JSON.stringify(
                selectedIds); // Pass selected IDs as a JSON string
                confirm_showPopup();
            } else {
                alert('No visitors selected. Please select one to delete.');
            }
        });
