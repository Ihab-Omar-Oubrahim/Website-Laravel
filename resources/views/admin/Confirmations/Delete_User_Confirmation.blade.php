<div id="confirmationPopup" class="confirm-popup hidden">
    <form class="confirm-popup-content" method="POST" action="{{ route('delete_user') }}">
        @csrf
        <input type="text" name="id" id="userIDtoDelete">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButton.addEventListener('click', function() {
            ...
            if (selectedIds.length === 1) {
                ...
                userIDtoDelete.value = selectedIds[
                ...
                userIDtoDelete.value = JSON.stringify(
                selectedIds); // Pass selected IDs as a JSON string
                confirm_showPopup();
            } else {
                alert('No users selected. Please select one to delete.');
            }
        });
