<div id="confirmationPopup" class="confirm-popup hidden">
    <form class="confirm-popup-content" method="POST" action="{{ route('delete_shared') }}">
        @csrf
        <input type="text" name="id" id="sharedIdtoDelete">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const sharedIdtoDelete = document.getElementById('sharedIdtoDelete');
        ...
        deleteButton.addEventListener('click', function() {
            ...
            if (selectedIds.length === 1) {
                ...
                sharedIdtoDelete.value = selectedIds[
                ...
                sharedIdtoDelete.value = JSON.stringify(
