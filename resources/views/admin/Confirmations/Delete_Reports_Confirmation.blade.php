<div id="confirmationPopup" class="confirm-popup hidden">
    <form class="confirm-popup-content" method="POST" action="{{ route('delete_report') }}">
        @csrf
        <input type="text" name="id" id="reportIdtoDelete">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButton.addEventListener('click', function() {
            ...
            if (selectedIds.length === 1) {
                ...
                reportIdtoDelete.value = selectedIds[
                ...
                reportIdtoDelete.value = JSON.stringify(
                selectedIds); // Pass selected IDs as a JSON string
                confirm_showPopup();
            } else {
                alert('No reports selected. Please select one to delete.');
            }
        });
