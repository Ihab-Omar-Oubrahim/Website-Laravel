<div id="confirmationPopup" class="confirm-popup hidden">
    <form class="confirm-popup-content" method="POST" action="{{ route('delete_comment') }}">
        @csrf
        <input type="text" name="id" id="commentIdtoDelete">
        ...
        <p id="Note_Msg">Note that the Replies and Reports of this comment will also be deleted.</p>
    </form>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButton.addEventListener('click', function() {
            ...
            if (selectedIds.length === 1) {
                ...
                commentIdtoDelete.value = selectedIds[
                ...
                commentIdtoDelete.value = JSON.stringify(
                selectedIds); // Pass selected IDs as a JSON string
                confirm_showPopup();
            } else {
                alert('No shared messages selected. Please select one to delete.');
            }
        });
